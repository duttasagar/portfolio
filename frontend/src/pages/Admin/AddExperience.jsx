...
//     try {
//       if (experience.id) {
//         await axios.put(`${API_URL}/experiences/${experience.id}`, experience);
//       } else {
...
//           className="bg-violet-600 hover:bg-violet-700 text-white px-5 py-3 rounded-lg font-medium transition"
//         >
//           + Add Experience
//         </button>
//       </div>
...
//             <p className="text-gray-500 text-lg">No experiences added yet.</p>
//           </div>
//         )}
//       </div>
